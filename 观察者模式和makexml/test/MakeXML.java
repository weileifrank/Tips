...
public class MakeXML {
	private final static String rootPath = "C:/Users/jackson.liu/Desktop/values/values-{0}x{1}";
    private final static int DW = 375;
    private final static int DH = 667;
    private final static float dw = DW;
    private final static float dh = DH;
    //	private final static float dw = 320f;
//	private final static float dh = 480f;
//    private final static String WTemplate = "<dimen name=\"x{0} tools:ignore=\"MissingDefaultResource\"\">{1}px</dimen>\n";
//    private final static String HTemplate = "<dimen name=\"y{0} tools:ignore=\"MissingDefaultResource\"\">{1}px</dimen>\n";
